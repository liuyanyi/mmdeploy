...
from mmdeploy.codebase.mmrotate.core.post_processing.bbox_nms import _multiclass_nms_rotated
...
def rtmdet_head__predict_by_feat(ctx,
    ...
    return _multiclass_nms_rotated(bboxes, scores, max_output_boxes_per_class,
